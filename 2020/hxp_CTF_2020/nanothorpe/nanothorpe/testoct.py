...
class octothorpe:
    ...
    def _finalize(self) -> bytearray:
        ...
        # print(clone._state) # bytearray(b'\x00\x11"3DUfw\x88\x99\xaa\xbb\xcc\xdd\xee\xff')
...
if __name__ == '__main__':
    print(octothorpe(b'hxp').hexdigest()) #'4e072c7a1872f7cdf3cb2cfc676b0311'
    print(octothorpe(b'hxp')._cache)
