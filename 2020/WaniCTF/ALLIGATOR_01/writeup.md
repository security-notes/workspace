...
問題文にて推奨されている`Volatility`を用いて、プロセスを調べた。

[参考]

* http://sectanlab.sblo.jp/category/4331321-1.html
...
INFO    : volatility.debug    : Determining profile based on KDBG search...
          Suggested Profile(s) : Win7SP1x86_23418, Win7SP0x86, Win7SP1x86_24000, Win7SP1x86
                     ...
                     AS Layer2 : FileAddressSpace (/media/sf_workspace/2020/WaniCTF/alligator_01/ALLIGATOR/ALLIGATOR.raw)
                      PAE type : PAE
                           DTB : 0x185000L
                          KDBG : 0x82754de8L
...
```bash
$ vol.py -f ALLIGATOR.raw  --kdbg=0x82754de8 --profile=Win7SP1x86_23418 pstree
...
`0x84dd6b28:evil.exe`が実行された日時がフラグである。
